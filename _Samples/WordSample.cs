...
namespace SimpleOfficeCreator.Standard._Samples
{
    internal class WordSample
    {
        public void CreateImage()
        {
            ...
            var model = officeModelCreator.CreatePicture(0, 0, 100, 100, base64String, officePictureStyle);
