...
namespace SimpleOfficeCreator.Stardard.Modules.DefaultAttributes
{
    internal class WordBase
    {
        ...
        private void GeneratePartContent(StyleDefinitionsPart part)
        {
            ...
            Languages languages1 = new Languages() { Val = "en-US", EastAsia = "ko-KR", Bidi = "ar-SA" };
            ...
            StyleName styleName5 = new StyleName() { Val = "No Spacing" };
            UIPriority uIPriority4 = new UIPriority() { Val = 1 };
            Rsid rsid1 = new Rsid() { Val = "00310BEB" };
